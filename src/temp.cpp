...
int main() {
    ...
    float acceleration_limit = 0.01f; // Maximum acceleration rate (as PWM duty cycle change p/ period)
    float deceleration_limit = 0.02f; // Maximum deceleration rate (as PWM duty cycle change p/ period)
    ...
    int top_limit_debounce_counter = 0;
    int bottom_limit_debounce_counter = 0;
    int start_stop_debounce_counter = 0;
